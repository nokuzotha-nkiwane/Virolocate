...
workflow VIROLOCATE_NF {
    ...
    //ch_split_group = SPLITTER.out.lst.groupTuple(by: 0).dump(tag:'ch_split_group')
    ...
    ch_taxonomy_id_collected = (SPLITTER.out.lst).join(ch_gb_grouped).dump(tag:'ch_taxonomy_id_collected')
