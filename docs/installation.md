...
## 5. Run the test profile of Virolocate
...
nextflow run nokuzotha-nkiwane/Virolocate -profile test,docker --outdir test_output


# For users with access to singularity containers
nextflow run nokuzotha-nkiwane/Virolocate -profile test,singularity --outdir test_output
